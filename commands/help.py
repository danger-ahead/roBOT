...
async def help_call(discord, message):
    ...
    embed.add_field(
            ...
            value="configure, deconfigure, configconfess, deconfigconfess, kick, mute, unmute, moderation, leave, clean",
            inline=False,
        )
    embed.add_field(
...
async def quiz(discord, message):
    embed = discord.Embed(
                title="Quiz 👽",
...
async def qstop(discord, message):
    embed = discord.Embed(
                title="Quiz Stop ❌",
...
async def scores(discord, message):
    embed = discord.Embed(
                title="Scores 💯",
...
async def nexT(discord, message):
    embed = discord.Embed(
                title="Next ⏭️",
...
async def reset(discord, message):
    embed = discord.Embed(
                title="Reset 🔄",
